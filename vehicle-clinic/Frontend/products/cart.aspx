...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="cartForm" runat="server">
        <div>
            <div class="col-md-10">
                <h3>Cart list <asp:Button Text="Empty Cart" CssClass="btn btn-danger pull-right custom-ml" ID="discardCart" OnClientClick="if (!confirm('Are you sure discard all?')) return false;" OnClick="discardCart_Click" runat="server" /> <asp:HyperLink CssClass="btn btn-warning pull-right" NavigateUrl="~/Frontend/products/index.aspx" runat="server">Continue Shop</asp:HyperLink></h3>
